  ...
  return (
    ...
    >
      ...
      <section id="interpretation">
        <h2 className="text-2xl">1. Interpretation</h2>
      ...
      <section id="services">
        <h2 className="text-2xl">2. Our Services</h2>
      ...
      <section id="privacy">
        <h2 className="text-2xl">3. Privacy Policy</h2>
        <p>
      ...
      <section id="age-restriction">
        <h2 className="text-2xl">4. Age Restriction</h2>
        <p>You must be at least 18 years old to use LocalDrive Services.</p>
      </section>

      <section id="license">
        <h2 className="text-2xl">5. License to Use Our Platform</h2>
        <p>
      ...
      <section id="who-may-use">
        <h2 className="text-2xl">6. Who May Use Our Services</h2>
        <ul style={{ listStyleType: "square", paddingLeft: "1rem" }}>
      ...
      <section id="bookings-payments">
        <h2 className="text-2xl">7. Booking, Payments, Cancellations & Refunds</h2>
        
        <h3 className="text-1xl">a. Payment Model</h3>
        <ul style={{ listStyleType: "square", paddingLeft: "1rem" }}>
        ...
        <h3 className="text-1xl">b. Cancellation & Refund Policy</h3>
        ...
        <h4 className="text-1xl">c. After Training Has Started</h4>
        <ul style={{ listStyleType: "square", paddingLeft: "1rem" }}>
        ...
        <h3 className="text-1xl">d. Lesson Rescheduling & Cancellation</h3>
        <ul style={{ listStyleType: "square", paddingLeft: "1rem" }}>
        ...
        <h3 className="text-1xl">e. Instructor Extensions</h3>
        <ul style={{ listStyleType: "square", paddingLeft: "1rem" }}>
        ...
        <h3 className="text-1xl">f. Package Expiration</h3>
        <ul style={{ listStyleType: "square", paddingLeft: "1rem" }}>
        ...
        <h3 className="text-1xl">g. Charges & Penalties</h3>
        <ul style={{ listStyleType: "square", paddingLeft: "1rem" }}>
      ...
      <section id="amendments">
        <h2 className="text-2xl">10. Amendments to Terms</h2>
        <p>
      ...
      <section id="account-security">
        <h2 className="text-2xl">11. Account Security</h2>
        <p>
      ...
      <section id="service-availability">
        <h2 className="text-2xl">12. Service Availability</h2>
        <p>
      ...
      <section id="termination">
        <h2 className="text-2xl">13. Termination</h2>
      ...
      <section id="liability">
        <h2 className="text-2xl">14. Limitation of Liability</h2>
        <p>
      ...
      <section id="indemnification">
        <h2 className="text-2xl">15. Indemnification</h2>
        <p>
      ...
      <section id="dispute-resolution">
        <h2 className="text-2xl">16. Dispute Resolution</h2>
        <ul>
      ...
      <section id="force-majeure">
        <h2 className="text-2xl">17. Force Majeure</h2>
        <p>
      ...
      <section id="updates">
        <h2 className="text-2xl">18. Updates to This Terms of Service</h2>
        <p>
