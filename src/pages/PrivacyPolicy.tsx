              ...
              <div className="prose prose-lg mx-auto text-muted-foreground">
                <div className="text-lg leading-relaxed mb-6">
                  <h2>LocalDrive Privacy Notice</h2>
                    ...
                    <ol>
                      <li>Empower the individual – You should be in charge of your personal information and make voluntary choices about your data.</li>
                      <li>Secure personal information – We do not take your trust for granted. We ensure appropriate security measures are in place to protect your information.</li>
                      <li>Transparency and education – We want you to clearly understand what personal information is collected, how, why, and how it is secured.</li>
                      <li>Abide by local laws – Our privacy practices comply with Nigerian Data Protection Act (NDPA 2023) and other applicable local regulations. If LocalDrive expands internationally, local laws will also be respected.</li>
                      <li>Collect only what is needed – We collect and store personal data only to provide our Services effectively, avoiding unnecessary or excessive data collection.</li>
                    </ol>
